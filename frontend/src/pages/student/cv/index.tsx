...
// Lấy base URL của backend để build đường dẫn đầy đủ cho file tĩnh
const BACKEND_URL = process.env.BACKEND_URL || 'http://localhost:3001';

function getFullPdfUrl(pdfUrl: string): string {
  // Nếu đã là URL đầy đủ thì giữ nguyên, ngược lại ghép với BACKEND_URL
...
export default function CvBuilderPage() {
  ...
  return (
    <div>
      ...
      {/* Modal xem CV PDF — hiển thị ngay trên trang, không mở tab mới */}
      <Modal
        open={pdfModalOpen}
