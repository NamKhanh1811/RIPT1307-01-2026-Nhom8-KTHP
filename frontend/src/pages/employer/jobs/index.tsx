  ...
  const onSave = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        // Đảm bảo salary là số hoặc null, không phải string
      ...
      // Hiện lỗi validation chi tiết từ backend nếu có
      ...
      // Lỗi antd form validation (client-side) không cần xử lý thêm
    } finally {
      setSaving(false);
    }
  };
